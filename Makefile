...
run-dovecot:
	docker run -e DB_NAME=postfixadmin -e DB_USER=postfixadmin -e DB_PASSWD=password -e DOMAIN=n00dl3.ovh -v /srv/certs:/srv/ssl -d -v /srv/vmail:/srv/vmail --link mysql:mysql --name dovecot dovecot:2.1.7
